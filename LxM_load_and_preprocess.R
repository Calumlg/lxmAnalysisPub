...
# DEFINE FUNCTION ====
 ...
 lxm_load_preprocess <- function(clean, tourn_remove) {
   ...
   # Data folder, relative to wherever this script (and the .Rmd sourcing
   # it) live - works on any computer, no editing needed
   ...
   fPathTbt <- file.path(base_dir, fileNameTbt)
   fPathSumm <- file.path(base_dir, fileNameSumm)
